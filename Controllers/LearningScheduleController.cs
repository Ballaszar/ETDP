...
namespace ETD.Api.Controllers
{
    ...
    public class LearningScheduleController : ControllerBase
    {
        ...
        private static void AppendLegalDisclaimerPage(Body body, Qualification? qualification)
        {
            ...
            body.Append(ScheduleBodyPara("The information in this courseware title is distributed on an 'as is' basis, without warranty. While every precaution has been taken in preparation of this courseware, neither Dr P.C. Wepener nor OpenAI shall have any liability to any person or entity for any loss or damage caused, or alleged to be caused, directly or indirectly by the instructions in this document or by the learning design and development processes described in it.", 18));
